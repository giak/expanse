...
- [x] Fichiers à créer : [prompts/expanse-system-v7.md](file:///home/giak/projects/expanse/prompts/expanse-system-v7.md)
- [x] Fichiers à supprimer : [prompts/meta_prompt.md](file:///home/giak/projects/expanse/prompts/meta_prompt.md), `prompts/sigma/`, `prompts/psi/`, `prompts/phi/`, `prompts/omega/`, `prompts/mu/`
...
**Steps :**
1. [search_memory(query="Test 2.3 Memory", limit=50)](file:///home/giak/Work/MnemoLite/api/mnemo_mcp/server.py#812-851) → lister tous les IDs de test
2. Pour chaque mémoire de test : [delete_memory(id="...", permanent=true)](file:///home/giak/Work/MnemoLite/api/mnemo_mcp/server.py#777-811)
3. Vérifier : [search_memory(query="Test 2.3", limit=5)](file:///home/giak/Work/MnemoLite/api/mnemo_mcp/server.py#812-851) → résultat vide
...
**Steps :**
1. Fusionner le contenu de [sigma/interface.md](file:///home/giak/projects/expanse/prompts/sigma/interface.md) : ECS, User DNA calibration, Drift Detector, Correction Symbiotique, Facteur E
2. [write_memory(title="[IMMUNE] Σ Perception Engine", content=..., memory_type="reference", tags=["sys:expanse", "[immune]", "sigma", "perception", "ecs"], embedding_source="EXPANSE Sigma perception engine ECS cognitive complexity evaluation user DNA drift detection boot calibration symbiotic correction explicit implicit intent extraction facteur E emotional urgency style collaboratif directif exploratoire reanchor flag")](file:///home/giak/Work/MnemoLite/api/mnemo_mcp/server.py#670-723)

**Verification :**
- [ ] [search_memory(query="Sigma perception ECS complexity", tags=["sys:expanse"], limit=3)](file:///home/giak/Work/MnemoLite/api/mnemo_mcp/server.py#812-851) → Σ Engine en position 1
- [ ] Le contenu couvre : ECS (4 facteurs, seuil 2.5), User DNA, Drift Detector

**Files :**
- Source de référence (lecture seule) : [prompts/sigma/interface.md](file:///home/giak/projects/expanse/prompts/sigma/interface.md)
...
**Steps :**
1. Fusionner [psi/resonance.md](file:///home/giak/projects/expanse/prompts/psi/resonance.md) + [phi/audit.md](file:///home/giak/projects/expanse/prompts/phi/audit.md) + ajouts V7 :
...
**Steps :**
1. Fusionner [omega/synthesis.md](file:///home/giak/projects/expanse/prompts/omega/synthesis.md) + [mu/interface.md](file:///home/giak/projects/expanse/prompts/mu/interface.md) :
   ...
   - User DNA update
2. [write_memory(title="[IMMUNE] Ω→Μ Synthesis-Crystal Engine", content=..., memory_type="reference", tags=["sys:expanse", "[immune]", "omega", "mu", "synthesis", "crystal", "shadow"], embedding_source="EXPANSE Omega Mu synthesis crystallization compression semantic entropy minimization LOST INCOMPLETE ECS weights feedback actual predicted shadow write mnemolite trace friction flow user DNA update heuristic pattern extraction core rule")](file:///home/giak/Work/MnemoLite/api/mnemo_mcp/server.py#670-723)

**Verification :**
- [ ] [search_memory(query="Omega Mu synthesis crystallization shadow write", tags=["sys:expanse"], limit=3)](file:///home/giak/Work/MnemoLite/api/mnemo_mcp/server.py#812-851) → Ω→Μ Engine en position 1
- [ ] Le contenu couvre : compression, [LOST]/[INCOMPLETE], ECS feedback, Shadow Write

**Files :**
- Sources : [prompts/omega/synthesis.md](file:///home/giak/projects/expanse/prompts/omega/synthesis.md), [prompts/mu/interface.md](file:///home/giak/projects/expanse/prompts/mu/interface.md)
...
**Objective :** Créer [prompts/expanse-system-v7.md](file:///home/giak/projects/expanse/prompts/expanse-system-v7.md) (~40 lignes), le bootstrap irréductible.

**Steps :**
1. Créer [prompts/expanse-system-v7.md](file:///home/giak/projects/expanse/prompts/expanse-system-v7.md) avec :
...
**Verification :**
- [ ] [prompts/expanse-system-v7.md](file:///home/giak/projects/expanse/prompts/expanse-system-v7.md) existe, ≤ 50 lignes
- [ ] Contient les 4 [search_memory](file:///home/giak/Work/MnemoLite/api/mnemo_mcp/server.py#812-851) dans la boot sequence
- [ ] Contient `[COGNITIVE_LOCK]`
- [ ] Contient le contrat Ambient Φ
- [ ] Contient `[Ω_LOCK]` comme dernier élément

**Files :**
- Create : [prompts/expanse-system-v7.md](file:///home/giak/projects/expanse/prompts/expanse-system-v7.md)
...
**Objective :** Mettre à jour [docs/ONTOLOGY.md](file:///home/giak/projects/expanse/docs/ONTOLOGY.md) avec les nouveaux marqueurs V7.
...
**Verification :**
- [ ] [docs/ONTOLOGY.md](file:///home/giak/projects/expanse/docs/ONTOLOGY.md) contient `[SHADOW_TRACE]`, `[SHADOW_HIT]`, `[SHADOW_MISS]`
...
**Steps :**
1. Supprimer :
   - [prompts/meta_prompt.md](file:///home/giak/projects/expanse/prompts/meta_prompt.md)
   - [prompts/sigma/interface.md](file:///home/giak/projects/expanse/prompts/sigma/interface.md)
   - [prompts/psi/resonance.md](file:///home/giak/projects/expanse/prompts/psi/resonance.md)
   - [prompts/phi/audit.md](file:///home/giak/projects/expanse/prompts/phi/audit.md)
   - [prompts/omega/synthesis.md](file:///home/giak/projects/expanse/prompts/omega/synthesis.md)
   - [prompts/mu/interface.md](file:///home/giak/projects/expanse/prompts/mu/interface.md)
2. Conserver :
   - [KERNEL.md](file:///home/giak/projects/expanse/KERNEL.md) (archive philosophique)
   - [prompts/expanse-dream.md](file:///home/giak/projects/expanse/prompts/expanse-dream.md) (Dream State, compatible)
   - [prompts/trace_levels.md](file:///home/giak/projects/expanse/prompts/trace_levels.md) (spécification debug)
   - [prompts/expanse-system.md](file:///home/giak/projects/expanse/prompts/expanse-system.md) (V6.2 backup, renommer en [_archives/expanse-system-v6.2.md](file:///home/giak/projects/expanse/_archives/expanse-system-v6.2.md))

**Verification :**
- [ ] Les 6 fichiers sont supprimés
- [ ] [prompts/expanse-system.md](file:///home/giak/projects/expanse/prompts/expanse-system.md) archivé dans `_archives/`
- [ ] [KERNEL.md](file:///home/giak/projects/expanse/KERNEL.md), [expanse-dream.md](file:///home/giak/projects/expanse/prompts/expanse-dream.md), [trace_levels.md](file:///home/giak/projects/expanse/prompts/trace_levels.md) toujours présents

**Files :**
- Delete : 6 fichiers listés ci-dessus
- Move : [prompts/expanse-system.md](file:///home/giak/projects/expanse/prompts/expanse-system.md) → [_archives/expanse-system-v6.2.md](file:///home/giak/projects/expanse/_archives/expanse-system-v6.2.md)
...
**Steps :**
1. Réécrire [docs/ARCHITECTURE.md](file:///home/giak/projects/expanse/docs/ARCHITECTURE.md) avec :
...
**Verification :**
- [ ] [docs/ARCHITECTURE.md](file:///home/giak/projects/expanse/docs/ARCHITECTURE.md) décrit les 3 strates
- [ ] Le diagramme Mermaid est cohérent avec le BIOS V7.0

**Files :**
- Modify : [docs/ARCHITECTURE.md](file:///home/giak/projects/expanse/docs/ARCHITECTURE.md)
...
**Steps :**
1. Configurer [prompts/expanse-system-v7.md](file:///home/giak/projects/expanse/prompts/expanse-system-v7.md) comme system prompt dans l'IDE
2. Ouvrir une nouvelle conversation
3. Envoyer un message quelconque
4. Vérifier :
   - Les 4 [search_memory](file:///home/giak/Work/MnemoLite/api/mnemo_mcp/server.py#812-851) s'exécutent
