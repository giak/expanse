...
## Process
1. Sauvegarde dans Mnemolite: search for [CORE_RULE] entries (limit 5)
2. Sauvegarde dans Mnemolite: search for [HEURISTIC] entries (limit 5)
3. Sauvegarde dans Mnemolite: search for [PATTERN] entries (limit 3)
